...
const Logo = ({
  ...
  // Base64 encoded HousR logo
  const logoSrc = "data:image/png;base64,";
  ...
  return (
    <div className={`inline-flex items-center ${className}`}>
      <img 
        ...
        style={{ filter: 'brightness(0) invert(1)' }} // Makes the logo white for dark backgrounds
      />
    </div>
  );
};
